...
async function verify() {
  try {
    console.log('=== MYSQL VERIFICATION FOR CREATIVE RIDDLES B.TECH 3RD YEAR SET 2 ===\n');
    ...
    if (duplicateOrders === 0 && duplicateQuestions === 0) {
      console.log(`[PASS] Zero duplicates found in SET 2.`);
    } else {
    ...
    if (matchingRounds.length === 1) {
      ...
      console.error(`[FAIL] Multiple rounds found for SET 2!`);
    }
